...
const data = [
  {
    ...
    "description": "Meer info over Hamsters."
  },
  {
    "title": "Sunflower Sago Friends",
    "image": "/images/regisseur.jpg",
    "description": "Meer info over Sunflower Sago Friends."
  }
];
  ...
  return (
    <main className="p-8 max-w-6xl mx-auto space-y-12">
      <header className="space-y-4 text-center">
        <h1 className="text-4xl font-bold">REGISSEUR</h1>
